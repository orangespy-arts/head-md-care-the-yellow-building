...
- RoomA2/
  - AngerWords1
  - AngerWords2
  - AngerWords1 (duplicate in original)
- RoomB2/
...
> Note: This cleaned file preserves all original entries but formats them as nested Markdown lists for better rendering. The original `AssetList.MD` is not modified.
